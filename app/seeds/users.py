...
def seed_users():
    ...
    cuddlist4 = Cuddlist(email='cuddlist4@cuddlist.com',
                         password='password',
                         first_name='Anna Joy',
                         last_name='Reedy',
                         location='Kansas City',
                         session_price=160,
                         travel_price=75,
                         about_me='Anna is a perfect mixture of present and playful. She is amazing at being with you and seeing you exaclty where you are. Her communications skills are absolutely breathtaking and they inspire clients left and right to grow and ask for what they want most. Anna hails from Seattle, while has been a fervent and bubbly travelor. She has extensive knowledge about somatic experiencign and is highly qualified in that treatment as well.',
                         session_info='These days a session with Anna happens on a lovely and beautiful hosue boat right on the Seattle water! Have you ever wanted to cuddle in a little boat with a breathtaking view? We think you have and have we got the spot for you. You do not need to bring anything, but a desire to experience a cuddle session and your bad self!')
